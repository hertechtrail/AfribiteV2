            ...
            <div className="flex flex-col laptop:flex-row items-center laptop:items-start gap-10 p-10">
                ...
                <div className="flex-1">
                    ...
                    <div className="flex items-center mt-4 rounded-lg overflow-hidden shadow-md">
                        <button
                            className="bg-[#4CAF50] text-white px-4 py-2 hover:bg-[#45A049] focus:outline-none"
            ...
            {isModalOpen && (
                <div className="fixed top-0 left-0 w-full h-full bg-black opacity-50 z-40"> {/* Backdrop */}
                    <div className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-white p-8 rounded-md z-50 shadow-md">
                        ...
                        <button
                            className="mt-4 border border-orange-500 text-orange-500 py-2 px-6 rounded-md"
                            onClick={closeModal}
                        >
                            Cancel
                        </button>
